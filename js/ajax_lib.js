...
c_ajax_object.prototype.CallXMLHTTPObjectGETParam2 = function ( in_url, in_callback, in_param, in_param2 ) {
	return this.CallXMLHTTPObject ( in_url, in_callback, "GET", in_param, null, in_param2, 0 );
}
...
function ParamsAJAXCall ( in_uri, in_callback, in_method, in_param, in_param2 ) {
	// The method indicator is actually optional, so we make it GET if nothing was passed.
	if ( (typeof in_method == 'undefined') || ((in_method != 'GET')&&(in_method != 'POST')) ) {
		in_method = 'GET';
		}
	...
	if ( SupportsAjax() && (typeof in_uri != 'undefined') && in_uri && (typeof in_callback == 'function') ) {
		if ( in_method == 'POST' ) {
			return g_ajax_obj.CallXMLHTTPObjectPOSTParamPartial ( in_uri, in_callback, in_param, in_param2 );
			} else {
			return g_ajax_obj.CallXMLHTTPObjectGETParamPartial ( in_uri, in_callback, in_param, in_param2 );
			}
		} else {
			return false;
		}
}
// NEEDS form_parser_helper.js
function FormParseAJAXCall ( in_uri, in_callback, in_method, in_param, in_form ){
	if ( (typeof in_method == 'undefined') || ((in_method != 'GET')&&(in_method != 'POST')) ) {
		in_method = 'GET';
		}
	var form_values = getFormValues ( in_form, 'validate' );
	in_uri = in_uri + '/' + form_values;

	in_method = in_method.toUpperCase();
// We verify that the proper parameters have been passed in.
	if ( SupportsAjax() && (typeof in_uri != 'undefined') && in_uri && (typeof in_callback == 'function') ) {
		if ( in_method == 'POST' ) {
			return g_ajax_obj.CallXMLHTTPObjectPOSTParamPartial ( in_uri, in_callback, in_param );
			} else {
			return g_ajax_obj.CallXMLHTTPObjectGETParamPartial ( in_uri, in_callback, in_param );
			}
		} else {
			return false;
		}
...
// NEEDS form_parser_helper.js
function ParamsFormParseAJAXCall ( in_uri, in_callback, in_method, in_param, in_param2, in_form ){
	displayLoading(in_param);
	if ( (typeof in_method == 'undefined') || ((in_method != 'GET')&&(in_method != 'POST')) ) {
		in_method = 'GET';
		}
