...
$action		= APPLICATION_URL."diagnostico-consumo.html";	
		...
		<div class="row">
			<div class="twelve columns"><!-- Main Panel Width -->
				<div class="panel header-explorar"> <!-- panel -->
					...
					<!-- Ribbon -->
					<div class="ribbon">
						<h2><span class="head-e"><span class="sprite-1 diagnostico-icon">Icon</span></span><strong>Diagnóstico: </strong>Planeación y Organización</h2>
					...
					<!-- End Ribbon -->
						...
						<div class="row question"><!-- Row Question 3 -->
							...
							<div class="eleven columns centered"><!-- 11 col -->
								<h5 class="text-center greytxt no-margin"><strong>Si no sabes como llegar a tus metas, es difícil que las alcances, responde unas preguntas para que sepas como estas en temas de planeación</strong></h5>
							</div>
							<br />
					...
					<div class="main-footer"><!--main footer-->
						...
						<div class="container clearfix"><!--container-->
							<div class="text-left left-btn left">
								<a href="<?php echo APPLICATION_URL?>diagnostico-metas.html" class="greytxt">Volver</a> |							
							...
							<div class="text-right right right-btn">
								<a href="javascript:void(0);" onClick="document.getElementById('questions').action='<?php echo APPLICATION_URL?>diagnostico-consumo.html';" class="pretty-btn-1 submit">Diagnóstico consumo </a>
