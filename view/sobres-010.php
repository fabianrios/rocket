		...
		<div class="row margin-top-30">
			<div class="twelve columns"><!-- Main Panel Width -->
				<div class="panel header-explorar"> <!-- panel -->
			    		...
			    		<!-- ribbon -->
			    		<div class="ribbon">
							<h2><span class="head-e"><span class="descubra-icon" data-icon="t"></span></span><strong>Sobres:</strong> Estos sobres son solo para ti</h2>
					...
					<div class="sobre-main">
						...
						<div class="new-expense add-expense-div" style="display:none;" >
							...
							<p class="text-right no-margin"><span aria-hidden="true" class="bluetxt" data-icon="j"></span></p>
								<!-- container -->
								<div class="container">
								...
								<li class="sobre-li <?php echo $class?>" id="envelopecontainer-<?php echo $userEnvelope->__get('user_envelope_id')?>">
									...
									<div class="sobre-info text-center">
										<h6 class="sobre-title greytxt"><strong><?php echo $userEnvelope->__get('user_envelope_name')?></strong></h6>
											<h5 class="sobre-value bluetxt" <?php if(($budget == '') || ($budget == 0)) { echo 'style="display:none;"'; } ?> id="budget-<?php echo $userEnvelope->__get('user_envelope_id')?>"><strong><span aria-hidden="true" data-icon="&#xe08c;"></span> $<?php echo formatNumber($budget, "0", ".", ".")?></strong></h5>										
