...
<meta charset="utf-8" />
	...
	<script language="JavaScript" src="<?php echo APPLICATION_URL?>javascripts/diagnostics-goals.js" ></script>
					...
					<div class="row"><!-- Main Row -->
					    <div class="goal-block-main3 grad2 left clearfix"><!-- 8 col -->
					        ...
					        <div class="container margin-top-30"><!-- container -->
					        	<h5 class="greytxt no-margin"><strong>¿Cúales son las metas que tienes y cuando las quieres hacer realidad?</strong></h5>
					        	<p class="no-margin">Haz click en tus metas y programalas</p>	
						...
						<div class="TimeLine-block left clearfix"><!-- 4 col -->
						...
						<div class="container clearfix"><!--container-->
							<div class="text-right right right-btn"><!--action-->
								<form id="diagnostics_form" action="<?php echo APPLICATION_URL?>diagnostico-planeacion.html" method="post">
									...
									<a href="<?php echo APPLICATION_URL?>diagnostico-010.html" class="greytxt"> <strong>Anterior</strong></a>
									<input type="submit" value="Diagnóstico planeación" class="pretty-btn-1" />
