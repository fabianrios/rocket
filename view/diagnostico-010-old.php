...
{
	$nextTab	= $tab+1;
	$action		= APPLICATION_URL."diagnostico-010/".$nextTab.".html";	
}
else
		...
		<div class="row">
			<div class="twelve columns"><!-- Main Panel Width -->
				<div class="panel header-explorar"> <!-- panel -->
					...
					<!-- Ribbon -->
					<div class="ribbon">
						<h2><span class="head-e"><span class="num">1</span></span><strong>Diagnostico</strong></h2>
