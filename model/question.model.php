<?php
class Question extends Builder implements Crud 
{
	public function __construct($id = NULL, $tablePrefix = 'iden_')
	{
		parent::__construct();
		
		$this->table       = $tablePrefix . 'questions';
		$this->identifyer  = 'question_id';
